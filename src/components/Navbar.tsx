      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between">
          ...
          <Link to="/">
            ...
            >
              <img src={logo} alt="Nextgen Estate" className="h-12 w-12 rounded-full object-cover" />
              <div className="hidden md:block">
                <h1 className="text-lg font-bold text-primary leading-tight">Nextgen Estate</h1>
                <p className="text-xs text-muted-foreground">Infra Advisors</p>
              </div>
            </motion.div>
          </Link>
          ...
          >
            <Link to="/contact">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="gradient-gold text-foreground px-6 py-2 rounded-lg font-semibold shadow-md hover:shadow-gold transition-all duration-300"
              >
                Get Started
              </motion.button>
            </Link>
